...
def coefficientOfDetermination(fcOI,propertyOfInterest,propertyOfInterest_Predicted):
    '''
    Function to compute the coefficient of determination (R^2) for a given feature collection
    '''
...
def RMSE(fcOI,propertyOfInterest,propertyOfInterest_Predicted):
    '''
    Function to compute the root mean squared error (RMSE) for a given feature collection
    '''
...
def MAE(fcOI,propertyOfInterest,propertyOfInterest_Predicted):
    '''
    Function to compute the mean absolute error (MAE) for a given feature collection
    '''
...
def computeCVAccuracyAndRMSE(featureWithClassifier):
    '''
    Function to compute the accuracy of a classifier across all folds of a cross-validation
    '''
    # Training dataset
